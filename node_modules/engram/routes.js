...
api.get("/bookmarks", function (req, res, next) {
	...
	var maxIdResult = preprocess.id(req.params.max_id);
	var amountResult = preprocess.amount(req.params.amount);

	Result.productOf(maxIdResult, amountResult).then(function (_ref) {
