...
app["delete"]("/bookmarks/:id", function (req, res) {
	...
	log.info({ id: req.params.id }, "DELETE /bookmarks/" + req.params.id);
...
api.post("/resave", function (req, res) {

	resaveBookmarks(req.body, req, res);
	res.status(200);
...
save.use(function (req, res) {
	...
	pathResult.onOk(function (path) {
		...
		saveBookmark(path, time, function (result) {
