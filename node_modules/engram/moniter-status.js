...
var saveStatus = function (recall, state, url) {
	...
	url.length === 0 ? recall(undefined, state.control.delay) : requestURL(url[0].url, {}, function (urlResult) {
...
var reporter = function (urlResult, state) {
	...
	urlResult.onErr(function (err) {
		...
		log.error({ message: err.message, stack: err.stack }, "failed to lookup url.");
