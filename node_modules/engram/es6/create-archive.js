...
var contentTypes = require('engram/es6/content-types')
	...
	requestURL(url, {encoding: null}, resResult => {
		...
		resResult.onOk( ({res, body}) => {
			...
			parsed.onErr(err => {
				...
				log.global.error({contentType, err, url}, 'content-type parsing failed.')
...
createArchive.html.precond = (url, body, contentType) => {
...
createArchive.fallback.precond = (url, body, contentType) => {
