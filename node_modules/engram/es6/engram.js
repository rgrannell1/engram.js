...
var moniterDaemons  = require('engram/moniter-daemons')
...
var startServer = (app, port, callback) => {
...
var engram = ({port, database}) => {
	...
	createTables(result => {
		...
		return startServer(app, port, result => {
