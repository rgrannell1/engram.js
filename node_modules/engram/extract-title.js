...
var trimTitle = function (uri, title) {
...
var extractTitle = function (_ref, callback) {
	var url = _ref.url;
	var res = _ref.res;
	var body = _ref.body;
...
extractTitle.html = function (_ref, callback) {
	var url = _ref.url;
	var res = _ref.res;
	var body = _ref.body;
...
extractTitle.pdf = function (_ref, callback) {
	var url = _ref.url;
	var res = _ref.res;
	var body = _ref.body;
};
