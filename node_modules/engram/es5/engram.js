...
var createCredentials = function (keypath, certpath) {
...
var loadCredentials = function (keypath, certpath) {
...
var startServer = function (app, port, start, keypath, certpath, callback) {
...
var wipeData = (function (_wipeData) {
	var _wipeDataWrapper = function wipeData(_x) {
		return _wipeData.apply(this, arguments);
	};

	_wipeDataWrapper.toString = function () {
		return _wipeData.toString();
	};

	return _wipeDataWrapper;
})(function (args) {
