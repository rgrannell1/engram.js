...
var createArchive = function createArchive(url, callback) {
	...
	requestURL(url, { encoding: null }, function (resResult) {
		...
		resResult.onOk(function (_ref) {
			...
			parsed.onErr(function (err) {
				...
				log.global.error({ contentType: contentType, err: err, url: url }, 'content-type parsing failed.');
...
createArchive.html.precond = function (url, body, contentType) {
...
createArchive.fallback.precond = function (url, body, contentType) {
