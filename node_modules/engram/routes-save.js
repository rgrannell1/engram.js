		...
		result.onOk(function () {
			...
			requestURL(url, { encoding: null }, function (reqResult) {
				...
				reqResult.onOk(function (_ref2) {
					...
					constants.BUS.fire(":request", { url: url, res: res, body: body });
				});
			});
		});
	});
