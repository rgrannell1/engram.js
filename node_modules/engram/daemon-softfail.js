...
var saveSoftFailStatus = function (reporter, urls) {

	urls.length === 0 ? reporter(Ok(undefined)) : isSoftFailer(urls[0].url, function (statusResult) {
